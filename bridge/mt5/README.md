...
- **Server URL**: The URL where `services/bridge` is running (e.g., `http://your-vps-ip:8005`).
...
- Added `OnTrade()` handler: fires on every deal and POSTs fill events to `/bridge/trades/fill`.
