...
def test_dashboard_overview_basic():
    ...
    with patch("services.dashboard.main.get_service_health") as mock_health, \
...
def test_dashboard_stale_packets_reflected():
    ...
    with patch("services.dashboard.main.get_service_health") as mock_health, \
        ...
        mock_data.return_value = {
            ...
            "events": [],
            "no_trade_windows": [],
            "latest_setups": [{"asset_pair": "BTC-USD", "stage": "A", "score": 80.0, "is_fresh": False}],
            "latest_decisions": [],
            "latest_incidents": []
        }
...
def test_dashboard_routes_render():
    ...
    routes = ["/dashboard/incidents", "/dashboard/setups", "/dashboard/risk", "/dashboard/reports"]
    for route in routes:
