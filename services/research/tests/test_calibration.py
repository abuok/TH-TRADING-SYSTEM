...
def test_analyze_variant_high_conviction():
    ...
    var = ResearchMetrics(
        executed_trades=80, expectancy_r=0.6, max_drawdown_r=1.5, win_rate_pct=52.0
    )
...
def test_analyze_variant_medium_conviction_strict_mode():
    ...
    var = ResearchMetrics(
        executed_trades=40, expectancy_r=0.52, max_drawdown_r=1.9, win_rate_pct=56.0
    )
...
def test_analyze_variant_medium_conviction_risk_dampener():
    ...
    var = ResearchMetrics(
        executed_trades=60, expectancy_r=0.45, max_drawdown_r=2.5, win_rate_pct=49.0
    )
...
def test_analyze_variant_no_recommendation():
    ...
    var = ResearchMetrics(
        executed_trades=90, expectancy_r=0.52, max_drawdown_r=2.1, win_rate_pct=51.0
    )
...
def test_generate_calibration_report():
    ...
    high_var = ResearchMetrics(
        executed_trades=80, expectancy_r=0.6, max_drawdown_r=1.5, win_rate_pct=52.0
    )
    meh_var = ResearchMetrics(
        executed_trades=90, expectancy_r=0.52, max_drawdown_r=2.1, win_rate_pct=51.0
    )
