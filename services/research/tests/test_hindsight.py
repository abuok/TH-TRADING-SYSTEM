...
def test_long_win_tp1(db_session):
    ...
    candles = [
        Candle(
            timestamp=datetime.now(), open=100, high=105, low=95, close=100, volume=0
        ),
        Candle(
            timestamp=datetime.now(), open=100, high=125, low=100, close=120, volume=0
        ),
    ]
...
def test_long_tie_breaker(db_session):
    ...
    candles = [
        Candle(
            timestamp=datetime.now(), open=100, high=130, low=80, close=100, volume=0
        )
    ]
    outcome = process_ticket_hindsight(db_session, ticket.ticket_id, candles)
...
def test_long_break_even(db_session):
    ...
    candles = [
        Candle(
            timestamp=datetime.now(), open=100, high=115, low=100, close=110, volume=0
        ),
        Candle(
            timestamp=datetime.now(), open=110, high=110, low=95, close=95, volume=0
        ),
    ]
    outcome = process_ticket_hindsight(db_session, ticket.ticket_id, candles)
    ...
    )  # The stop loss triggered, it was just physically at the Entry.
...
def test_short_win_tp1(db_session):
    ...
    candles = [
        ...
        Candle(
            timestamp=datetime.now(), open=100, high=100, low=75, close=80, volume=0
        ),
    ]
    outcome = process_ticket_hindsight(db_session, ticket.ticket_id, candles)
...
def test_short_break_even(db_session):
    ...
    candles = [
        Candle(
            timestamp=datetime.now(), open=100, high=100, low=85, close=90, volume=0
        ),
        Candle(
            timestamp=datetime.now(), open=90, high=115, low=90, close=110, volume=0
        ),
    ]
    outcome = process_ticket_hindsight(db_session, ticket.ticket_id, candles)
