...
if __name__ == "__main__":
    ...
    comp_parser.add_argument("--csv", type=str, required=True, help="Path to historical CSV")
    comp_parser.add_argument("--pair", type=str, default="XAUUSD", help="Asset pair")
    comp_parser.add_argument("--days", type=int, default=30, help="Number of days to look back")
