...
class Proposal(BaseModel):
    ...
    target: str = Field(
        ...,
        description="Category of the target change. EG: guardrails, policy, queue, execution_prep, management",
    )
    proposed_change: str = Field(
        ..., description="A detailed description of the proposed parameter change"
    )
...
class TuningProposalReport(BaseModel):
    ...
    created_at_eat: datetime = Field(
        ..., description="Timestamp of generation (Africa/Nairobi)"
    )
