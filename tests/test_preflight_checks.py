...
def test_preflight_kill_switch(db_session: Session):
    ...
    ticket = OrderTicket(ticket_id="TK_KS", pair="XAUUSD", entry_price=2000.0, setup_packet_id=1, risk_packet_id=1, direction="BUY", stop_loss=1990.0, take_profit_1=2020.0, lot_size=0.1, risk_usd=100.0, risk_pct=1.0, rr_tp1=2.0, idempotency_key="KS_IK")
